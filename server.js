...
const app = express();
// changed the port to this, i had some apps i run on my local machine
const port = 1234; // changing this value and restarting the server will change the port on which the app listens
...
app.get('/api/v1/funds', (req, res, next) => {
  ...
  if (!term) {
    ...
    res.setHeader('Access-Control-Allow-Origin','*'); // also added this for the cross domain access
